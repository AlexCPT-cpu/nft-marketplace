...
const NftCard = ({
  ...
  const [liked, setLiked] = useState<boolean>(
    data?.likeIds.includes(user.user.id)
  );
      ...
      <div className="relative">
        ...
        <div className="absolute top-2 right-3">
          <div
            ...
            className="px-2 flex flex-row space-x-2 bg-white rounded-full text-black cursor-pointer"
          >
            <HeartIcon
              className={`w-5 mr-2 transition ${
