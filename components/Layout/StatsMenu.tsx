...
const StatsMenu: React.FC<StatsProps> = ({ visible }) => {
  ...
  return (
    <div className="bg-white border border-gray-300 dark:border-gray-800 rounded-md dark:bg-[#041824] text-base w-40 absolute transition top-16 left-[500px] py-3 flex-col flex">
      <Link
